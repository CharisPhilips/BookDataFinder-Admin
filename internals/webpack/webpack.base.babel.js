...
module.exports = options => ({
  ...
  resolve: {
    ...
    alias: {
      'bdf-components': path.resolve(__dirname, '../../app/components/'),
      'bdf-actions': path.resolve(__dirname, '../../app/actions/'),
      'bdf-styles': path.resolve(__dirname, '../../app/styles/components/'),
      'bdf-api': path.resolve(__dirname, '../../app/api/'),
      'bdf-images': path.resolve(__dirname, '../../public/images/'),
      'bdf-vendor': path.resolve(__dirname, '../../node_modules/'),
    }
  },
